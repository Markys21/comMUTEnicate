                ...
                <div class="screen">
                    ...
                    <div class="screen-body">
                        ...
                        <div class="screen-body-item">
                            <div class="app-form">
                                <div class="app-form-group app-title">
                                <h5 class="text-white"><?php echo strtoupper($fetch['user_name']); ?></h5>
                                </div>
                                <div class="app-form-group message">
                                    <textarea id="textToSpeak" rows="4" cols="50" class="app-form-control form-control" placeholder="Enter text here..."></textarea>
                                </div>
                                <div class="app-form-group buttons">
                                    <button onclick="stopSpeaking()" class="app-form-button">PAUSE</button>
                                    <button onclick="speak()" class="app-form-button">SPEAK</button>
                                    <button onclick="downloadAudio()" class="app-form-button">DOWNLOAD</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
     let synth = window.speechSynthesis;
        ...
        function downloadAudio() {
            ...
            if (text !== "") {
                utterance.text = text;
                let audioBlob = new Blob([text], { type: 'audio/mpeg' });
                let audioUrl = URL.createObjectURL(audioBlob);

                let downloadLink = document.createElement('a');
                downloadLink.href = audioUrl;
                downloadLink.download = 'speech_audio.mp3'; // Change the filename if desired
                downloadLink.click();
            }
        }
