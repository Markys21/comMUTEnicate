...
<div id="body-pd">
    <header class="header" id="header">
        ...
        <h4>School / <a href="./userboard.php">Go Back</a></h4>
    </header>
...
$buttons1 = mysqli_query($conn, "SELECT * FROM button WHERE historyremove = 1 AND status = 1 AND categ = 12 AND user = '' ORDER BY id");
...
"SELECT * FROM button WHERE historyremove = 1 AND status = 1 AND categ = 12 AND user = '$user' ORDER BY id"); 
